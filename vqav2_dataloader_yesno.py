...
class VQAv2Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"img": img, "question": question,
                "main_answer": main_answer, "prompts":prompts}
